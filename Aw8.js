...
(async () => {
...

  {
    ...
    await puppeteer.Locator.race([
      targetPage.locator('li:nth-of-type(10) img'),
      targetPage.locator('::-p-xpath(//*[@id="root"]/div[1]/div[6]/div/div[2]/ul/li[10]/div[1]/img)'),
      targetPage.locator(':scope >>> li:nth-of-type(10) img')
    ])
      .setTimeout(timeout)
      .click({
        offset: {
